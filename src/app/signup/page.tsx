  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
      ...
      <div className='text-center m-3 gap-3 flex flex-col w-full p-3 '>
        <input type="username" placeholder=' Username' className='p-3 bg-[#121212] outline-none' />
        <input type="password" placeholder='Email or mobile number' className='p-3 bg-[#121212] outline-none' />
      ...
      <div className='text-center m-1 gap-3 flex flex-col w-full p-3'>
        <button className='bg-[#3797EF] p-3'>Create Account</button>
      </div>
      ...
      <div className='flex mt-8 gap-1'>
        ...
        <Link className='text-[#3797EF] ' href="/signup">Log In</Link>
      </div>
    </div>
  );
}
